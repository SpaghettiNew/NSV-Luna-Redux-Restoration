...
//This now has a native function it seems
/*proc/arctan(x)
...
//					if(AR.ul_Lighting)							//TODO: rewrite this code so it's not messed by lighting ~Carn
//						X.opacity = !X.opacity
...
//						if(AR2.ul_Lighting)						//TODO: rewrite this code so it's not messed by lighting ~Carn
