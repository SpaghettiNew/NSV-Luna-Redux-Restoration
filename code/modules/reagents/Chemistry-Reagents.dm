...
datum/reagent/toxin/chloralhydrate
	...
	toxpwr = 1
	metabolization_rate = 0.1 //Default 0.2
...
datum/reagent/toxin/beer2	//disguised as normal beer for use by emagged brobots
	...
	metabolization_rate = 0.15 // Sleep toxins should always be consumed pretty fast
...
datum/reagent/ethanol/dwine
	...
	boozepwr = 4
	dizzy_adj = 2
	slur_start = 10			//amount absorbed after which mob starts slurring
	confused_start = 20	//amount absorbed after which mob starts confusing directions
	blur_start = 50
	pass_out = 100
